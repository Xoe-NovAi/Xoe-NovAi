# Archived: Local Telemetry-Free TTS Options 2025

This document has been canonicalized into `docs/LOCAL_TELEMETRY_FREE_TTS_OPTIONS_2025.md`.
The original root snapshot has been archived at `docs/archive/LOCAL_TELEMETRY_FREE_TTS_OPTIONS_2025.md`.

Please consult the canonical copy in `docs/` for the latest maintained version.
